...
public class Signal_Processing {
    ...
    static final public double[][] Periodogram(double dataset[], int sampleRate, boolean applyWindow) {
        ...
        //populate a list of points as [normalized f, value]
        //We need to scale by 1/k.
        double[][] valuesFreqPoints = new double[2][k / 2];
        for (int i = 0; i < k / 2; i++) {
            valuesFreqPoints[0][i] = i * delta_f;
            valuesFreqPoints[1][i] =  (FFTValues[i].magnitude()*FFTValues[i].magnitude())/k;
        }
    ...
    static final public double[][] averagedPeriodogram(double dataset[], int sampleRate, int windowWidth, int numWindows){
        ...
        for(int i=0;i<numWindows;i++){
            ...
            intervalPeriodograms[i] = Periodogram(currentWindowData,sampleRate,true)[1];
        ...
        double delta_f = sampleRate / windowWidth;
        double[][] valuesFreqPoints = new double[2][windowWidth/2];
        for (int i = 0; i < windowWidth / 2; i++) {
            valuesFreqPoints[0][i] = i * delta_f;
            valuesFreqPoints[1][i] = finalAveragedValues[i];
        }
